...
const svgs = `  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="like">
...
const videoVapo = ` <video autoplay muted playsinline id="leftSideVideo" class="side videoleft"> 
                        <source src="./videos/VAPO.mp4" type="video/mp4">
                    </video>`;

const videoEnElHall = ` <video autoplay muted playsinline id="rightSideVideo" class="side videoright"> 
